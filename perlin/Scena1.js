...
class Scena1 {
  ...
  this.positionButton();  // Center the button
  ...
  // On button click, start the scene and play the sound
   ...
   stylePlayButton() {
    ...
    // Position the button at the bottom-left with 100px padding from right and bottom
    positionButton() {
      const buttonWidth = 150;  // Button width
      const buttonHeight = 60;  // Button height
      this.playButton2.position(windowWidth - buttonWidth - 100, windowHeight - buttonHeight - 100);
    }
